<template>
  <div type="tab-composite-view" title="tab-composite">
    <div slot="content">
      <jjsnc-tab-bar v-model="selectedLabel"
                    show-slider
      ...
      <div class="tab-slide-container">
        ...
        >
          <!-- 关注 -->
          <jjsnc-slide-item>
            <jjsnc-scroll :data="followersData" :options="scrollOptions">
          ...
          <!-- 推荐 -->
          <jjsnc-slide-item>
            <jjsnc-scroll :data="recommendData" :options="scrollOptions">
              <ul class="list-wrapper">
          ...
          <jjsnc-slide-item>
            <jjsnc-scroll :data="hotData" :options="scrollOptions">
              <ul class="list-wrapper">
...
<script type="text/ecmascript-6">
  ...
  import { FOLLOWERS_DATA, RECOMMEND_DATA, HOT_DATA } from '../example/data/tab-bar'

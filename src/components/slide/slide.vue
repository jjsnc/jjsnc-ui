<template>
  <div class="jjsnc-slide" ref="slide">
    <div class="jjsnc-slide-group" ref="slideGroup">
      <slot>
        <jjsnc-slide-item
...
export default {
  ...
  methods: {
    ...
    _initSlide() {
      const eventPassthrough =
        this.direction === DIRECTION_H && this.allowVertical ? DIRECTION_V : "";

  ...
  <div class="jjsnc-scroll-nav" :class="{'jjsnc-scroll-nav_side': side}">
    <jjsnc-sticky ref="sticky" :pos="scrollY" @change="stickyChangeHandler">
      ...
      >
        ...
        <div class="jjsnc-scroll-nav-main">
          <jjsnc-sticky-ele ref="navBarEle" ele-key="jjsnc-scroll-nav-bar">
          ...
          >
            <div class="jjsnc-scroll-nav-panels">
              <slot></slot>
            </div>
...
import jjsncScrollNavBar from "../scroll-nav-bar/scroll-nav-bar.vue";
